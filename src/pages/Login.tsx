...
import { ArrowLeft, Eye, EyeOff, Car } from "lucide-react";
      ...
      <div className="flex-1 px-6 flex flex-col justify-center">
        <div className="max-w-md mx-auto w-full">
          ...
          <div className="flex items-center gap-3 mb-8">
            <div className="w-14 h-14 rounded-2xl gradient-hero flex items-center justify-center shadow-glow-primary">
              <Car className="w-8 h-8 text-primary-foreground" />
            </div>
            <div>
              <h1 className="text-2xl font-bold text-foreground">CNH 360</h1>
